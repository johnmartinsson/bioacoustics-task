...
def dcase_to_scaper_source_material(csv_paths, source_base_dir, class_name):
    for csv_path in csv_paths:
        n_shots = 1000000
        pos_anns = get_positive_annotations(csv_path, n_shots=n_shots, class_name='Q', expand=0.0)
...
def main():
    ...
    parser.add_argument('--source_output_dir', type=str, help='Path to the output source directory.')
    ...
    produce_dcase_foreground_source_material(dcase_base_dir, args.source_output_dir)
    produce_nigens_foreground_source_material(nigens_base_dir, args.source_output_dir, nigens_classes)
    produce_tut_background_source_material(tut_base_dir, args.source_output_dir)
